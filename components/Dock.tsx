...
interface DockProps {
  openWindow: (id: AppId, rect: DOMRect) => void;
}
...
const DockItem = ({ mouseX, app, isMobile, onClick }: { mouseX: MotionValue<number | null>; app: any; isMobile: boolean; onClick: (rect: DOMRect) => void }) => {
